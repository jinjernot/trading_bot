...
async def open_position_long(symbol, df, stoch_k, stoch_d, usdt_balance, support, resistance, atr_value, funding_rate, support_4h, resistance_4h):
    ...
    # --- REMOVED: Bollinger Band Squeeze Check has been removed ---
    ...
    if AGGRESSIVE_ENTRY:
        ...
        if (stochastic_signal and price_above_sma and rsi_is_bullish):
        ...
        if (stochastic_signal and price_above_sma and rsi_is_bullish and confirmation_is_bullish):
...
async def open_position_short(symbol, df, stoch_k, stoch_d, usdt_balance, support, resistance, atr_value, funding_rate, support_4h, resistance_4h):
    ...
    if AGGRESSIVE_ENTRY:
        ...
        if (stochastic_signal and price_below_sma and rsi_is_bearish):
        ...
        if (stochastic_signal and price_below_sma and rsi_is_bearish and confirmation_is_bearish):
